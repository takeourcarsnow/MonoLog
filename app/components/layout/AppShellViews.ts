...
const FeedView = lazy(() => import("@/app/components/feed/FeedView").then(mod => ({ default: mod.FeedView })));
const ExploreView = lazy(() => import("@/app/components/explore/ExploreView").then(mod => ({ default: mod.ExploreView })));
const Uploader = lazy(() => import("@/app/components/Uploader").then(mod => ({ default: mod.Uploader })));
const CalendarView = lazy(() => import("@/app/components/calendar/CalendarView").then(mod => ({ default: mod.CalendarView })));
const ProfileView = lazy(() => import("@/app/components/profile/ProfileView").then(mod => ({ default: mod.ProfileView })));
