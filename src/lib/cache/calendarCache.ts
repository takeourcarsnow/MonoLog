...
export const statsByMonth: Record<string, { counts: Record<string, number>; mine: Set<string> }> = {};
...
export function setStats(key: string, data: { counts: Record<string, number>; mine: Set<string> }) {
